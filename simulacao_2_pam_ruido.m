...
% -------------------------------------------------------------------------
% Filtro de Tx+Rx
% Formatacao de Pulso - Tipo Raiz Quadrada de Cosseno Elevado no Tx e Rx         
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
% Canal Passa Baixas Simulado usando um Filtro de Butterworth e Adicao de
% Ruido Gaussiano
% -------------------------------------------------------------------------
...
reqSNR = 10;                         %Relacao sinal-ruido (Eb/N0) em dB
...
% Densidade Espectral de Potencia do na Saida do Canal
...
% Densidade Espectral de Potencia do na Saida do Filtro Casado
...
eyediagram(sinal_rx_casado(1,10000:15000),2*oversampling)     %Diagrama de olho

[num_erros,BER]=symerr(bit_matrix_rx,bit_matrix); % Contagem do número de erros e 
                                                  % calculo da BER

disp ('Numero de erros = ') 
disp(num_erros)
disp ('BER simulada = ')
disp(BER)
